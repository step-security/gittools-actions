...
> The examples use version _v4_ of the GitReleaseManager Setup action (major version tag).  It is recommended to use the latest released version in your own workflows.
...
steps:
  - name: Install GitReleaseManager
    uses: step-security/gittools-actions/gitreleasemanager/setup@v4
    with:
      versionSpec: '0.20.x'
```
