...
> The examples use version _v4_ of the GitVersion Setup action (major version tag).  It is recommended to use the latest released version in your own workflows.
